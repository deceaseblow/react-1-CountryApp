...
function RandomCard({ country }) {
  ...
  return (
    <div className="flex justify-center items-center min-h-[50vh] bg-gray-100 px-4 font-poppins">
      <div
        className="randomCard group bg-black border border-purple-600 rounded-xl shadow-lg p-8 w-full max-w-3xl text-purple-600
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-3 justify-center md:justify-start">
              <FaCity className="text-purple-600 text-xl transition group-hover:text-black" />
              <div>
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start">
              <FaMapMarkedAlt className="text-purple-400 text-xl transition group-hover:text-black" />
              <div>
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start">
              <FaUsers className="text-purple-400 text-xl transition group-hover:text-black" />
              <div>
