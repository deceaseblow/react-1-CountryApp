...
function RandomCard({ country }) {
  ...
  return (
    <div className="flex justify-center items-center min-h-[50vh] bg-gray-100 px-4 font-poppins">
      <div
        className="randomCard bg-black border border-pink-600 rounded-xl shadow-lg p-8 w-full max-w-3xl text-pink-600
          flex flex-col md:flex-row items-center gap-8
          transition-all duration-300 hover:bg-pink-600 hover:text-black cursor-default"
      >
        <img
          src={flags.png}
          alt={`${name} flag`}
          className="w-72 h-48 object-cover rounded-lg border border-pink-600"
          loading="lazy"
        />
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-3 justify-center md:justify-start">
              <FaCity className="text-pink-400 text-xl" />
              <div>
